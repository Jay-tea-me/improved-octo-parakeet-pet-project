...
struct IntegratedSignOutController: UIViewControllerRepresentable {
    func makeUIViewController(context: UIViewControllerRepresentableContext<IntegratedSignOutController>)
    -> SignOutViewController {
        let controller = SignOutViewController()
        return controller
    }

    func updateUIViewController(_ uiViewController: SignOutViewController,
                                context: UIViewControllerRepresentableContext<IntegratedSignOutController>) {}
